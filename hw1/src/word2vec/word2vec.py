...
def skip_gram(args, dat, sample_num, iteration, batch_size, learning_rate, vector_size, vocab_size):
...
def main():
	...
	w_vector = skip_gram(args=args, dat=dat, sample_num=50, iteration=10, batch_size=100, learning_rate=0.8, vector_size=128, vocab_size=len(v2i))
